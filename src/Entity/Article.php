...
class Article
{
     ...
     * @Assert\NotBlank(message="You should pick a title")
     */
    private $title;
    ...
    public function incHeartCount(): self
    {
    ...
    {
        if (stripos($this->getTitle(),'lorem') !== false) {
            $context->buildViolation('Dont use Loren in your title...Its boring !')
            ->atPath('title')
            ->addViolation();
        }
    }
